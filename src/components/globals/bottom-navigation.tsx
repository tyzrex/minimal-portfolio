...
const BottomNavigation: React.FC = () => {
  ...
  return (
    <>
      ...
      <div className="fixed bottom-4 left-1/2 transform -translate-x-1/2 z-50 block md:hidden max-w-[90%]">
            ...
            {nav.map((item) => {
              ...
              return (
                <button
                  ...
                  onClick={item.action}
                  aria-label={item.id}
                  className={`relative py-2 px-3 sm:px-5 rounded-full transition-all duration-200 flex flex-col items-center justify-center focus:outline-none focus-visible:ring-2 focus-visible:ring-red-400/60 ${
                    active
